        ...
        <div className="flex flex-col">
          <div className="flex flex-col md:flex-row md:justify-between mb-6">
            ...
            <div className="mt-4 md:mt-0 md:w-2/5 text-right">
              <h3 className="text-lg font-heading text-white">Contact Details</h3>
          ...
          <form className="flex flex-col">
            ...
            <input type="text" id="name" className="mb-4 p-2 bg-white text-black rounded-[15px]" required />
            <label htmlFor="company" className="mb-2 text-white">Company*</label>
            <input type="text" id="company" className="mb-4 p-2 bg-white text-black rounded-[15px]" required />
            <label htmlFor="email" className="mb-2 text-white">Email*</label>
            <input type="email" id="email" className="mb-4 p-2 bg-white text-black rounded-[15px]" required />
            <label htmlFor="message" className="mb-2 text-white">Message</label>
            <textarea id="message" className="mb-4 p-2 bg-white text-black rounded-[15px]" rows={4} required />
            <button className="font-button bg-green text-darkgreen px-6 h-[40px] rounded-full">{button}</button>
          </form>
        </div>

        <div className="flex justify-center">
          {image1?.node && (
            <img src={image1.node.sourceUrl} srcSet={image1.node.srcSet} alt="Contact Us" className="rounded-lg object-cover" />
          )}
        </div>
      </div>
    </div>
